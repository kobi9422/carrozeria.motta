...
import { FileText, Plus, X, Trash2, Send, Check, XCircle, Euro, User, Printer } from 'lucide-react';
...
export default function PreventiviPage() {
  ...
  const [preventivoDaStampare, setPreventivoD aStampare] = useState<any | null>(null);
  ...
  const handleStampa = (preventivo: any) => {
    setPreventivoD aStampare(preventivo);
    setTimeout(() => {
      window.print();
    }, 100);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-2">Gestisci i preventivi per i clienti</p>
          </div>
          <button
      ...
      {preventivoDaStampare && (
        <div ref={printRef} className="hidden print:block">
          <PrintPreventivo preventivo={preventivoDaStampare} />
        </div>
      )}
